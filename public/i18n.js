  ...
  ko: {
    ...
    html: {
      ...
      distSub:
        ...
        '가는 선이 월별 원값, 굵은 선이 <strong>3개월 후행평균</strong>입니다. 1개월 연율은 ' +
  ...
  ja: {
    ...
    html: {
      ...
      distSub:
        ...
        '細い線が月次の元の値、太い線が<strong>3か月後方移動平均</strong>です。1か月年率は' +
